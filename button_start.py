...
class TextButton:
    def __init__(self, screen, center_x, center_y, text, text_color=(255, 255, 255), background_color=(255, 0, 0),
                 border_color=(255, 255, 255), padding=20, font_name="elephant", font_size=24):
        self.screen = screen
        font = pygame.font.SysFont(font_name, font_size)
        self.caption = font.render(text.upper(), True, text_color)
    ...
    def draw(self):
        ...
        pygame.draw.rect(self.screen, self.background_color, (self.bound_left_x, self.bound_top_y, width / 2, height))
        pygame.draw.rect(self.screen, "blue", (self.bound_left_x + width / 2, self.bound_top_y, width / 2, height))
